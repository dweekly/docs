...
1. First, select an ad format.
	- For App Install or App Engagement campaigns you'll want to select the **App Only** format.
	- For Search or Display campaigns where the user should go to web if they don't have the app, then you should select **Cross-Platform Search** or **Cross-Platform Display**.
	- **Product Links** are for shopping or dynamic re-marketing campaigns and will take you to create a Deep Linked Product Feed.
...
- **Channels**: generally correspond to Ad Networks Name
- **Campaigns**: correspond to marketing initiatives that you're launching.  
- **Tags**: Use it to organize your link data with labels that don't fit within the bounds of the above.

For example: **Channel**: "YouTube", **Campaign**: "Summer 2017 Shoe" **Tag**: “Discount”.
...
4. Click **Create Link Now**, and you have your tracking link!
...
1. **Click-through URL**
2. **Third-party impression tracking URLs (optional)**

Make sure to hit the **TEST** Button and verify the links are working before pushing the campaign live.
