...
**If you want to support routing to your app (not just web)**
...
4. Finally, add the following analytics parameters needed to categorize your data accurately.
    ...
    2. [Facebook Analytics Parameters](#facebook-parameters)
    3. [Google Ads Analytics Parameters](#google-ads-parameters)
...
The following parameters and corresponding values should be appended to your Branch link base domain - <code>[https://example.app.link](https://example.app.link) -</code> for Facebook Ad campaigns.
<table>
  <tr>
...
The following parameters and corresponding values should be appended to your Branch link base domain - <code>[https://example.app.link](https://example.app.link) -</code> for Google Ads campaigns.
<table>
  <tr>
   <td><strong>Parameter</strong>
   </td>
