...
1. Add the following required keys to the <notranslate>**Deep Linking**</notranslate> sub tab during link configuration:
	- spotGroupId
	- spotId
	- reportingBucket
	- advertiserId
...
1. This is also your chance to add analytics tags. Analytics tags are important for later segmentation, so click the <notranslate>**Analytics**</notranslate> sub tab to add a Channel and Campaign value.
